...
public struct ShowLoadingAndErrorsBehavior {
    public let errorsBehavior: ErrorsBehavior

    public init(errorsBehavior: ErrorsBehavior) {
        self.errorsBehavior = errorsBehavior
    }

    public enum ErrorsBehavior {
        case preferErrorOverFallbackValue
        case preferFallbackValueOverError
    }
}
...
public extension ResourceState {
    ...
    func addLoadingAndErrorStates<BaseItemModelType: ItemModel, SectionModelType: SectionModel>(
        ...
        where BaseItemModelType.E == E {
            ...
            case .result:
                switch behavior.errorsBehavior {
                case .preferErrorOverFallbackValue:
