...
public struct DefaultListViewDatasourceCore<Datasource: DatasourceProtocol, ItemViewProducer: ListItemViewProducer, Section_: ListSection> {
...
extension DefaultListViewDatasourceCore {
