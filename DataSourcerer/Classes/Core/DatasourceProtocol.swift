...
public protocol DatasourceProtocol {
    ...
    typealias StatesOverTime = (DatasourceState) -> ()
...
public typealias DatasourceObservableCore<Value, P: Parameters, E: DatasourceError> = DefaultObservable<State<Value, P, E>>
